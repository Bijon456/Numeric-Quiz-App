...
public class Intermediate extends AppCompatActivity {
    ...
    public void newQuestion()
    {
        ...
        final int a = new Random().nextInt(50) + 50;
        final int b = new Random().nextInt(50) + 50;
        ...
        for(int i=0;i<4;i++)
        {
            ...
            {
                int wrongAnswer= new Random().nextInt(100) + 100;
                while(wrongAnswer==a+b);
                {
                    wrongAnswer= new Random().nextInt(100) + 100;
                }
